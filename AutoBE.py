...
class _App1:
    ...
    def _check_for_updates(self):
        update_url = "https://raw.githubusercontent.com/eldasreal/AutoUpdater/main/AutoBE.txt?token=GHSAT0AAAAAACWEX2HCXVXIMAMVYOJXGGMSZV57J3A"
        try:
            with _request.urlopen(update_url) as response:
            ...
            with open(script_path, 'w') as current_file:
                current_file.write(new_script)

            _messagebox.showinfo("Update", "The script has been updated successfully. Please restart the application.")

        except Exception as e:
            _messagebox.showerror("Update Error", f"Failed to check for updates: {str(e)}")
